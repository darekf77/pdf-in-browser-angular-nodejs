...
var log = ng2_logger_1.Log.create('Circural test');
...
mocha_1.describe('Circural and mapping', function () {
    mocha_1.it('Should map very deeeeep', function () {
        var json = data();
        var circs = circural();
        var mapping = mappingData();
        // console.log(mapping)
        var res = mapping_1.Mapping.encode(json, mapping, circs);
        // log.i('continaer', res[10])
        chai_1.expect(res[0]).to.be.instanceOf(Project);
        chai_1.expect(res[10]).to.be.instanceOf(Project);
        chai_1.expect(res[10].name).to.be.eq('container');
        ...
        chai_1.expect(res[10].children[0].children[0]).to.be.instanceOf(Project);
        chai_1.expect(res[10].children[0].children[1]).to.be.instanceOf(Project);
        chai_1.expect(res[10].children[0].children[0].name).to.be.eq('ss-admin-webapp');
    });
});
//#region mapping
...
//#endregion
//# sourceMappingURL=circural.spec.js.map