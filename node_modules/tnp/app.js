...
var process_1 = require("./apps/process");
var project_1 = require("./apps/project");
//#endregion
var controllers = [
    project_1.ProjectController,
    process_1.ProcessController
];
    ...
    AppComponent.prototype.ngOnInit = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, process_1.PROCESS.getAll()];
                    case 1:
                        processes = _a.sent();
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib_1.__decorate([
        core_1.NgModule({
            imports: tslib_1.__spreadArrays([
            ...
            providers: tslib_1.__spreadArrays(controllers),
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, morphi_1.Morphi.init({
                            ...
                            entities: [
                                project_1.PROJECT, process_1.PROCESS
                            ],
                            //#region @backend
                            config: config
                            //#endregion
